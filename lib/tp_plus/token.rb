module TPPlus
  class Token
    KEYWORDS = {
        ...
        "DEFAULT_USER_FRAME" => :TP_APPLICATION_MEMBER,
        "DEFAULT_TOOL_FRAME" => :TP_APPLICATION_MEMBER,
        "START_DELAY" => :TP_APPLICATION_MEMBER,
        "TRACKING_PROCESS" => :TP_APPLICATION_MEMBER,

        "AUTO_SINGULARITY_HEADER" => :TP_APPLICATION_TYPE,
        "ENABLE_SINGULARITY_AVOIDANCE" => :TP_APPLICATION_MEMBER,
